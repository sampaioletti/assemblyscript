...
<<<<<<< HEAD
 ...
 (func $~lib/rt/pure/markGray (; 9 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
 ...
 (func $~lib/rt/pure/scanBlack (; 11 ;) (type $FUNCSIG$vi) (param $0 i32)
  local.get $0
  local.get $0
  i32.load offset=4
  i32.const -1879048193
 ...
 (func $~lib/rt/pure/scan (; 12 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
 ...
 (func $~lib/rt/pure/collectWhite (; 13 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
 ...
 (func $~lib/rt/pure/__collect (; 14 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/rt/tlsf/reallocateBlock (; 28 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/rt/tlsf/__realloc (; 29 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  global.get $~lib/rt/tlsf/ROOT
  i32.eqz
  if
   i32.const 0
 ...
 (func $~lib/array/ensureSize (; 31 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 1
 ...
 (func $relocatable/main (; 34 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
