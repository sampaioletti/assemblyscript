(module
 ...
 (import "env" "log" (func $app1/assembly/index/log<~lib/string/String> (param i32 i32)))
 (import "env" "__rem_call" (func $app1/assembly/index/__rem_call<~lib/string/String> (param i32 i32) (result i32)))
 (import "app2" "sayHello" (func $app1/assembly/index/_sayHello (param i32) (result i32)))
 (import "env" "__rem_return" (func $app1/assembly/index/__rem_return<~lib/string/String> (param i32 i32) (result i32)))
 (memory $0 1)
 ...
 (data (i32.const 256) "\08\00\00\00\01\00\00\00\01\00\00\00\08\00\00\00a\00p\00p\002\00")
 (data (i32.const 280) "\04\00\00\00\01\00\00\00\00\00\00\00\04\00\00\00\10\01\00\00")
 (data (i32.const 304) "\10\00\00\00\01\00\00\00\03\00\00\00\10\00\00\00(\01\00\00(\01\00\00\04\00\00\00\01\00\00\00")
 (data (i32.const 336) " \00\00\00\01\00\00\00\01\00\00\00 \00\00\00H\00e\00l\00l\00o\00 \00F\00r\00o\00m\00 \00A\00p\00p\00 \001\00")
 (data (i32.const 384) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\93 \00\00\02\00\00\00")
 (table $0 1 funcref)
 ...
 (global $app1/assembly/index/__ctx i32 (i32.const 320))
 ...
 (export "__ctx" (global $app1/assembly/index/__ctx))
 (export "__rem_call<~lib/string/String>" (func $app1/assembly/index/__rem_call<~lib/string/String>))
 (export "__rem_return<~lib/string/String>" (func $app1/assembly/index/__rem_return<~lib/string/String>))
 ...
 (func $app1/assembly/index/sayHello (; 32 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  ...
  i32.const 0
  local.get $0
  call $app1/assembly/index/__rem_call<~lib/string/String>
  local.tee $1 ;;this ist the i32 pointing to app2 data that has been copied
  call $app1/assembly/index/_sayHello
  local.tee $2 ;;this is a i32 pointing to app2 data
  call $app1/assembly/index/__rem_return<~lib/string/String>
  local.set $3 ;;this is the local string copied over
  local.get $1 ;;renote...shouldnt release??
  i32.const 0
  call $app1/assembly/index/log<~lib/string/String>
  local.get $2;;this is a i32
  i32.const 0
  call $app1/assembly/index/log<~lib/string/String>
  local.get $0 ;; m is possed from main
  i32.const 0
  call $app1/assembly/index/log<~lib/string/String>
  local.get $3
 )
 (func $app1/assembly/index/main (; 33 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  i32.const 352
  call $~lib/rt/pure/__retain
 ...
 (func $~lib/array/Array<~lib/string/String>#__visit_impl (; 35 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
