(module
 ...
 (import "env" "__rem_call" (func $app1/assembly/index/__rem_call (param i32 i32) (result i32)))
 (import "app2" "concat" (func $app1/assembly/index/_concat (param i32 i32 i32) (result i32)))
 (import "env" "__rem_return" (func $app1/assembly/index/__rem_return (param i32 i32) (result i32)))
 (import "env" "log" (func $env/env/log (param i32)))
 (memory $0 1)
 ...
 (data (i32.const 360) "\02\00\00\00\01\00\00\00\01\00\00\00\02\00\00\00b\00")
 ...
 (export "__rem_call" (func $app1/assembly/index/__rem_call))
 (export "__rem_return" (func $app1/assembly/index/__rem_return))
 ...
 (func $app1/assembly/index/concat (; 31 ;) (type $FUNCSIG$iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  local.get $0
  ...
  i32.const 0
  local.get $0
  call $app1/assembly/index/__rem_call
  i32.const 0
  local.get $1
  call $app1/assembly/index/__rem_call
  local.get $2
  call $app1/assembly/index/_concat
  call $app1/assembly/index/__rem_return
  local.set $3
  local.get $0
 ...
 (func $app1/assembly/index/main (; 32 ;) (type $FUNCSIG$v)
  (local $0 i32)
  i32.const 352
  i32.const 376
  i32.const 10
  call $app1/assembly/index/concat
  local.set $0
  local.get $0
  call $env/env/log
  local.get $0
 ...
 (func $~lib/array/Array<~lib/string/String>#__visit_impl (; 34 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
