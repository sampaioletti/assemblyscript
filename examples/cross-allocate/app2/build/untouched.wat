(module
 ...
 (import "env" "log" (func $app2/assembly/index/log (param i32 i32)))
 (import "env" "dispatch" (func $app2/assembly/index/dispatch<~lib/string/String> (param i32 i32) (result i32)))
 (memory $0 1)
 ...
 (data (i32.const 256) "\1e\00\00\00\01\00\00\00\01\00\00\00\1e\00\00\00h\00e\00l\00l\00o\00 \00f\00r\00o\00m\00 \00a\00p\00p\002\00")
 ...
 (export "sayHello" (func $app2/assembly/index/sayHello))
 (export "add" (func $app2/assembly/index/add))
 ...
 (func $app2/assembly/index/sayHello (; 30 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  ...
  local.get $1
  call $~lib/string/String#get:length
  call $app2/assembly/index/dispatch<~lib/string/String>
  local.set $2
  local.get $1
 ...
 (func $app2/assembly/index/add (; 31 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
 )
